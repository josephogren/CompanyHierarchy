...
namespace CompanyHierarchy
{
    class Display
    {
        ...
        {
            LinkedList<TreeNode<Employee>> list = Search.listSubLevelEmployees(searchTree, name);
        ...
        {
            LinkedList<TreeNode<Employee>> list = Search.listSameLevelEmployees(searchTree, name);
            foreach (TreeNode<Employee> element in list)
            {
                Console.Write("{0}, ", element.Data);
            }
